...
const Express = () => {
  ...
  return transactions.filter((row) => {
    ...
    const isRush = Number(row.is_rush) === 1;

    return matchesPayment && matchesInventory && matchesSearch && isRush;
  ...
  const columns = [
    ...
    { name: 'Amount', selector: (row) => `₱${Number(row.amount).toFixed(2)}` },
        ...
        <div className="express-modal">
          ...
          <div className="express-modal-content">
            ...
            <ul>
              ...
              {selectedTxn.receipt_items?.map((svc) => ( // ⭐ FIX
